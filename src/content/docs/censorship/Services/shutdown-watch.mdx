...
<LinkPreview id="https://shutdown.activaterights.org/" />

### Details

| Type            | Service                                                                  |
| --------------- | ------------------------------------------------------------------------ |
| Probe location  | Bangladesh                                                               |
| Action type     | Aggregated Data Provider                                                 |
| Probing methods | Community Data Collection (News)                                         |
| Testing on      | Datacenter connections, Residential connection                           |
| Useful for      | Websites and web services accessibility monitoring, Outages of ASNs/ISPs |
